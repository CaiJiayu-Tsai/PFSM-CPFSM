...
/**
 * This is an implementation of the CPFSM algorithm <br/>
 * <br/>
 *
 * The CPFSM algorithm is described in the paper: <br/>
 * <br/>
 *
 ...
 * <br/>
 *
 * The CPFSM algorithm finds all the closed periodic frequents subgraphs in a graph database provided by the user. <br/>
 * <br/>
 *
 * This implementation saves the result to a file
 *
 */
public class AlgoCPFSM {
     ...
     */
    public void runAlgorithm(String inPath, String outPath, double minSupport, int minPeriodicity,
...
//                    System.out.println(v1 + " " + v2 + " " + vMap.get(v1).id + " " + vMap.get(v2).id);
    ...
    private void cgSpanDFS(DFSCode c, List<DatabaseGraph> graphDB, Set<Integer> graphIds, Projected projected, EarlyTerminationFailureHandler earlyTerminationFailureHandler)
            ...
            for (ExtendedEdge extension : orderedExtensions) {
                ...
                if (sup >= supportPruningThreshold
                    ...
                    if (isCanonical(newC)) {
                        ...
                        newC.largestPeriodicity = maxperiod;
                        newC.smallestPeriodicity = minperiod;
                        newC.averagePeriodicity = averageperiod;
                        newC.sup = sup;
        ...
        if (c.size() > 0) {
            if (c.averagePeriodicity <= maxAveragePeriodicity
                    && c.averagePeriodicity >= minAveragePeriodicity
                    && c.smallestPeriodicity >= minPeriodicity
                    && c.largestPeriodicity <= maxPeriodicity) {
                ...
                if (!hasEquivalentOccurrence) {
                    ...
                    subgraph.largestPeriodicity = c.largestPeriodicity;
                    subgraph.smallestPeriodicity = c.smallestPeriodicity;
                    subgraph.averagePeriodicity = c.averagePeriodicity;
    ...
    public List<Integer> getlistperiodset(Set<Integer> newGraphIDs, List<DatabaseGraph> graphDB) {
    ...
    public void printStats() {
        System.out.println("=============  CPFSM v2.53 - STATS =============");
        System.out.println(" Number of graph in the input database: " + graphCount);
        System.out.println(" Closed periodic frequent subgraph count : " + patternCount);
